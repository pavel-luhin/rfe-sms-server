...
public class EmailServiceImpl implements EmailService {
  ...
  public void sendPostRegistrationEmail(String email, String password) {
    ...
    parameterMap.put(SERVER_URL.getKey(), System.getProperty("server.url"));
    parameterMap.put(SmsParams.EMAIL.getKey(), email);
    parameterMap.put(SmsParams.PASSWORD.getKey(), password);
    parameterMap.put(SmsParams.USERNAME.getKey(), email.split("@")[0]);
  ...
  @Override
  public void processSendingEmail(Map.Entry<String, RecipientType> recipient,
      Map<String, String> parameters, String smsType) {
