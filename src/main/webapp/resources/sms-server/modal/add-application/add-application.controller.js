(function () {
    ...
    addApplicationCtrl.$inject = ['addApplicationService', '$scope', '$uibModalInstance', 'toaster'];
    function addApplicationCtrl(addApplicationService, $scope, $uibModalInstance, toaster) {
        $scope.selected = {};
