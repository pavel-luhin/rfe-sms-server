(function () {
    ...
    addEmailTemplateCtrl.$inject = ['addEmailTemplateService', '$scope', '$uibModalInstance', 'toaster'];
    function addEmailTemplateCtrl(addEmailTemplateService, $scope, $uibModalInstance, toaster) {
        addEmailTemplateService.getAvailableSMSTemplates().then(function (response) {
