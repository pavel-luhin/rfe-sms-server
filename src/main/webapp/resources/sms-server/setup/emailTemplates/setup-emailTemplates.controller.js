(function () {
    ...
    setupEmailTemplatesCtrl.$inject = ['setupEmailTemplatesService', '$scope', '$uibModal', 'confirmService'];
    function setupEmailTemplatesCtrl(setupEmailTemplatesService, $scope, $uibModal, confirmService) {
        ...
        $scope.addEmailTemplateModal = function () {
            $uibModal.open({
                ...
                templateUrl: 'resources/sms-server/modal/add-emailtemplate/add-emailtemplate.tmpl.html',
        ...
        $scope.removeEmailTemplate = function (id) {
            confirmService.showModal({}, confirmDeleteModalOptions).then(function (result) {
                setupEmailTemplatesService.removeEmailTemplate(id).then(function (data) {
                    getEmailTemplates();
                })
            });
        };
