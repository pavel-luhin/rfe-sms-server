(function () {
    ...
    setupTemplatesCtrl.$inject = ['setupTemplatesService', '$scope', '$uibModal', 'confirmService'];
    function setupTemplatesCtrl(setupTemplatesService, $scope, $uibModal, confirmService) {
        ...
        $scope.removeSMSTemplate = function (id) {
            confirmService.showModal({}, confirmDeleteModalOptions).then(function (result) {
                confirmService.showModal({}, confirmDeleteEmailTemplateModalOptions).then(function (result) {
