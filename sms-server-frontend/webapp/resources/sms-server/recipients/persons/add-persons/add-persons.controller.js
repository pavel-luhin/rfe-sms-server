(function () {
  ...
  addPersonsCtrl.$inject = ['addPersonsService', '$scope', '$location',
    'confirmService', '$routeParams'];

  function addPersonsCtrl(addPersonsService, $scope, $location, confirmService,
      $routeParams) {
    var sortConstants = {
      notSorted: {
    ...
    $scope.getAllPersons = function () {
      addPersonsService.getPersons(skip, currentPageSize, sortField,
