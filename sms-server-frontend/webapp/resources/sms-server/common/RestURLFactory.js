(function () {
  ...
  angular
  .module('sms-server')
  .factory('RestURLFactory', urlFactory);
  ...
  function urlFactory() {
    ...
    return {
      ...
      PERSONS_WITH_GROUP: BASE_REST_PREFIX
      + "/recipient/persons/withGroup/",
      PERSONS_WITHOUT_GROUP: BASE_REST_PREFIX
      + "/recipient/persons/withoutGroup/",
